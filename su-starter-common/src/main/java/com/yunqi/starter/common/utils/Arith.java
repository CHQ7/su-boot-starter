...
public class Arith {
    ...
    public static long div(long v1, long v2, int scale) {
        ...
        return b1.divide (b2, scale, RoundingMode.HALF_UP).longValue();
    }
     ...
     * @return
     */
    public static long Y2F(long v1) {
        return Arith.mul(v1, 100);
    }
     ...
     * @return
     */
    public static long F2Y(long v1) {
        return Arith.div(v1, 100,1);
    }
     ...
     * @return
     */
    public static String F2Y(String v1) {
        BigDecimal b1 = new BigDecimal(v1);
        return b1.divide (new BigDecimal(100)).toString();
    }
}
