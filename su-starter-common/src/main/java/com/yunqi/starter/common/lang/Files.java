...
public class Files {
    ...
    public static String read(String path) {
        File f = org.nutz.lang.Files.findFile(path);
        if (null == f)
    ...
    public static void write(String path, Object obj) {
        if (null == path || null == obj)
            return;
        try {
            write(org.nutz.lang.Files.createFileIfNoExists(path), obj);
        }
        catch (IOException e) {
    ...
    public static void write(File f, Object obj) {
        ...
        try {
            // 保证文件存在
            if (!f.exists())
                org.nutz.lang.Files.createNewFile(f);
            // 输入流
    ...
    public static File createDirIfNoExists(String path) {
        ...
        File f = new File(thePath);
        if (!f.exists()) {
            boolean flag = org.nutz.lang.Files.makeDir(f);
            if (!flag) {
    ...
    public static File createDirIfNoExists(File d) {
        if (null == d)
            return d;
        if (!d.exists()) {
            if (!org.nutz.lang.Files.makeDir(d)) {
    ...
    public static File findFile(String path, ClassLoader klassLoader) {
        return findFile(path, klassLoader, org.nutz.lang.Encoding.defaultEncoding());
    }
     ...
     *
     * @return 得到文件对象数组
     * @see org.nutz.lang.Files.LsMode
     */
    public static File[] ls(File d, final Pattern p, final boolean exclude, org.nutz.lang.Files.LsMode mode) {
        if (null == p) {
            return d.listFiles();
        }
        // 全部
        else if (null == mode || org.nutz.lang.Files.LsMode.ALL == mode) {
        ...
        // 仅文件
        else if (org.nutz.lang.Files.LsMode.FILE == mode) {
            return d.listFiles(new FileFilter() {
                public boolean accept(File f) {
                    if (!f.isFile())
                        return false;
        ...
        // 仅目录
        else if (org.nutz.lang.Files.LsMode.DIR == mode) {
            return d.listFiles(new FileFilter() {
                public boolean accept(File f) {
                    if (!f.isDirectory())
                        return false;
     ...
     *            模式
     * @return 文件列表对象
     * @see #ls(File, Pattern, boolean, org.nutz.lang.Files.LsMode)
     */
    public static File[] ls(File d, String regex, org.nutz.lang.Files.LsMode mode) {
        boolean exclude = false;
        Pattern p = null;
        if (!org.nutz.lang.Strings.isBlank(regex)) {
            exclude = regex.startsWith("!");
            if (exclude) {
                regex = org.nutz.lang.Strings.trim(regex.substring(1));
            }
    ...
    /**
     * @see #ls(File, String, org.nutz.lang.Files.LsMode)
     */
    public static File[] ls(String path, String regex, org.nutz.lang.Files.LsMode mode) {
    ...
    public static File[] lsFile(File d, String regex) {
        return ls(d, regex, org.nutz.lang.Files.LsMode.FILE);
    }

    /**
     * @see #ls(String, String, org.nutz.lang.Files.LsMode)
     */
    public static File[] lsFile(String path, String regex) {
        return ls(path, regex, org.nutz.lang.Files.LsMode.FILE);
    }
    ...
    public static File[] lsDir(File d, String regex) {
        return ls(d, regex, org.nutz.lang.Files.LsMode.DIR);
    }
    ...
    public static File[] lsDir(String path, String regex) {
        return ls(path, regex, org.nutz.lang.Files.LsMode.DIR);
    }
    ...
    public static File[] lsAll(File d, String regex) {
        return ls(d, regex, org.nutz.lang.Files.LsMode.ALL);
    }
    ...
    public static File[] lsAll(String path, String regex) {
        return ls(path, regex, org.nutz.lang.Files.LsMode.ALL);
    }
    ...
    public static File findFile(String path) {
        return findFile(path, ClassTools.getClassLoader(), org.nutz.lang.Encoding.defaultEncoding());
    }
    ...
    public static InputStream findFileAsStream(String path, String enc) {
        return findFileAsStream(path, org.nutz.lang.Files.class, enc);
    }
    ...
    public static InputStream findFileAsStream(String path, Class<?> klass) {
        return findFileAsStream(path, klass, org.nutz.lang.Encoding.defaultEncoding());
    }
    ...
    public static InputStream findFileAsStream(String path) {
        return findFileAsStream(path, org.nutz.lang.Files.class, Encoding.defaultEncoding());
    }
        ...
        if (fs != null) {
            for (File f : fs) {
                if (f.isFile())
                    ...
                    org.nutz.lang.Files.deleteDir(f);
            }
        }
        return true;
    }
    ...
    public static boolean rename(File src, String newName) {
        ...
        if (src.exists()) {
            ...
            if (newFile.exists())
                return false;
            org.nutz.lang.Files.makeDir(newFile.getParentFile());
    ...
    public static String renamePath(String path, String newName) {
        if (!org.nutz.lang.Strings.isBlank(path)) {
