...
public class Strings {
    ...
    public static String replaceBy(CharSequence cs, Map<String, Object> map) {
        ...
        // 准备两个分组
        List<String> keys1 = new ArrayList<>(map.size());
        List<String> keys2 = new ArrayList<>(map.size());
    ...
    /**
     * 去掉字符串前空白字符。空白字符的定义由Character.isWhitespace来判断
     *
     * @param cs
     *            字符串
     * @return 去掉了前空白字符的新字符串
     */
    ...
    /**
     * 去掉字符串后空白字符。空白字符的定义由Character.isWhitespace来判断
     *
     * @param cs
     *            字符串
     * @return 去掉了后空白字符的新字符串
     */
